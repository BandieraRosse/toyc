...
- normal world batch 必须整批可表达才使用 GPU；B2d-4a 的普通 RFM2 material alpha 可由 flat/textured source-over command 表达，支持的 Transparent V1 不触发 fallback；高级 sphere/toon/specular、bilinear、edge、overlay 或其他 unsupported input 仍导致整批 CPU fallback。
