...
$(BUILD)/rf_gpu.o: rasterfall/src/rf_gpu.c rasterfall/include/rf_gpu.h | $(BUILD)
	@printf "  $(BLUE)  GCC$(RESET)  %s\n" "$<"
	$(GCC) $(LIBC_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@
...
$(BUILD)/rasterfall_gui.o: $(RASTERFALL_SRC)/rasterfall_gui.c \
...
$(BUILD)/rasterfall_roster.o: $(RASTERFALL_SRC)/rasterfall_roster.c \
                              $(RASTERFALL_INC)/rasterfall_roster.h \
                              $(RASTERFALL_INC)/rasterfall_character.h | $(BUILD)
	@printf "  $(BLUE)  GCC$(RESET)  %s\n" "$<"
	$(GCC) $(LIBC_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@

$(BUILD)/rasterfall_prop.o: $(RASTERFALL_SRC)/rasterfall_prop.c \
                            $(RASTERFALL_INC)/rasterfall_prop.h \
                            $(RASTERFALL_INC)/rasterfall_units.h | $(BUILD)
	@printf "  $(BLUE)  GCC$(RESET)  %s\n" "$<"
	$(GCC) $(LIBC_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@
...
$(BUILD)/rasterfall_map_components.o: $(RASTERFALL_LIB)/rasterfall_map_components.c \
    $(RASTERFALL_INC)/rasterfall_map_components.h | $(BUILD)
	$(GCC) $(LIBC_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@
...
$(BUILD)/rasterfall_net_transport.o: $(RASTERFALL_SRC)/rasterfall_net_transport.c \
                                     $(RASTERFALL_INC)/rasterfall_net_transport.h | $(BUILD)
	@printf "  $(BLUE)  GCC$(RESET)  %s\n" "$<"
	$(GCC) $(LIBC_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@

$(BUILD)/rasterfall_net_discovery.o: $(RASTERFALL_SRC)/rasterfall_net_discovery.c \
                                     $(RASTERFALL_INC)/rasterfall_net.h | $(BUILD)
	@printf "  $(BLUE)  GCC$(RESET)  %s\n" "$<"
	$(GCC) $(LIBC_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@
...
$(BUILD)/rasterfall_render.o: $(RASTERFALL_SRC)/rasterfall_render.c \
    $(RASTERFALL_INC)/rasterfall_draw.h \
    $(RASTERFALL_SRC)/render/rasterfall_draw_reference.inc \
    $(RASTERFALL_SRC)/dev-tests/rasterfall_draw_reference_test.inc \
    ...
    $(RASTERFALL_INC)/rasterfall_map_components.h \
                              ...
                              $(RASTERFALL_INC)/rasterfall_session.h \
                              $(RASTERFALL_INC)/rasterfall_effects.h \
                              $(RASTERFALL_INC)/rasterfall_animation.h \
...
$(BUILD)/rasterfall_render_resources.o: $(RASTERFALL_SRC)/render/rasterfall_render_resources.c $(RASTERFALL_SRC)/dev-tests/rasterfall_render_resources_test.inc $(RASTERFALL_INC)/rasterfall_render_resources.h $(RASTERFALL_INC)/rasterfall_model.h | $(BUILD)
	$(GCC) $(LIBC_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@

$(BUILD)/rasterfall_render_frontend.o: $(RASTERFALL_SRC)/render/rasterfall_render_frontend.c \
                                       $(RASTERFALL_INC)/rasterfall_render_frontend.h \
                                       $(RASTERFALL_INC)/rasterfall_render.h | $(BUILD)
	@printf "  $(BLUE)  GCC$(RESET)  %s\n" "$<"
	$(GCC) $(LIBC_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@
...
$(BUILD)/rasterfall_humanoid_basis.o: $(RASTERFALL_SRC)/rasterfall_humanoid_basis.c \
                                      $(RASTERFALL_INC)/rasterfall_humanoid_basis.h | $(BUILD)
	@printf "  $(BLUE)  GCC$(RESET)  %s\n" "$<"
	$(GCC) $(LIBC_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@

$(BUILD)/rasterfall_humanoid_retarget.o: $(RASTERFALL_SRC)/rasterfall_humanoid_retarget.c \
                                         $(RASTERFALL_INC)/rasterfall_humanoid_retarget.h | $(BUILD)
	@printf "  $(BLUE)  GCC$(RESET)  %s\n" "$<"
	$(GCC) $(LIBC_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@
...
$(BUILD)/rasterfall_vmd.o: $(RASTERFALL_SRC)/rasterfall_vmd.c \
                            $(RASTERFALL_INC)/rasterfall_vmd.h \
                            $(RASTERFALL_INC)/rasterfall_model.h | $(BUILD)
	@printf "  $(BLUE)  GCC$(RESET)  %s\n" "$<"
	$(GCC) $(LIBC_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@
...
.PHONY: app-map-inspect test-map-parser app-map-runtime-test test-map-runtime test-map-components
...
test-map-components: app-map-inspect
	python3 tools/test_map_components.py
...
test-map-layout-query:
	python3 tools/test_map_layout_query.py
...
clean-app:
	...
	rm -f $(BUILD)/rasterfall_game.o $(BUILD)/rasterfall_sfx.o \
	      ...
	      $(BUILD)/rasterfall_ai.o $(BUILD)/rasterfall_ai_self.o \
	      $(BUILD)/rasterfall_net.o $(BUILD)/rasterfall_net_self.o \
	      $(BUILD)/rasterfall_net_transport.o $(BUILD)/rasterfall_net_transport_self.o \
	      $(BUILD)/rasterfall_net_discovery.o $(BUILD)/rasterfall_net_discovery_self.o \
...
$(BUILD)/rasterfall_map_components_self.o: $(RASTERFALL_LIB)/rasterfall_map_components.c \
    $(RASTERFALL_INC)/rasterfall_map_components.h $(SELF_CC) | $(BUILD)
	$(SELF_CC) $(SELF_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@
...
$(BUILD)/rasterfall_ai_self.o: $(RASTERFALL_SRC)/rasterfall_ai.c \
                               $(RASTERFALL_INC)/rasterfall_ai.h \
                               $(RASTERFALL_INC)/toy_game.h $(SELF_CC) | $(BUILD)
	@printf "  $(BLUE)  CC(s)  %s\n" "$<"
	$(SELF_CC) $(SELF_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@
...
$(BUILD)/rasterfall_net_transport_self.o: $(RASTERFALL_SRC)/rasterfall_net_transport.c \
                                          $(RASTERFALL_INC)/rasterfall_net_transport.h \
                                          $(SELF_CC) | $(BUILD)
	@printf "  $(BLUE)  CC(s)  %s\n" "$<"
	$(SELF_CC) $(SELF_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@

$(BUILD)/rasterfall_net_discovery_self.o: $(RASTERFALL_SRC)/rasterfall_net_discovery.c \
                                          $(RASTERFALL_INC)/rasterfall_net.h \
                                          $(SELF_CC) | $(BUILD)
	@printf "  $(BLUE)  CC(s)  %s\n" "$<"
	$(SELF_CC) $(SELF_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@
...
$(BUILD)/rasterfall_render_resources_self.o: $(RASTERFALL_SRC)/render/rasterfall_render_resources.c $(RASTERFALL_SRC)/dev-tests/rasterfall_render_resources_test.inc $(RASTERFALL_INC)/rasterfall_render_resources.h $(RASTERFALL_INC)/rasterfall_model.h $(SELF_CC) | $(BUILD)
	$(SELF_CC) $(SELF_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@
...
$(BUILD)/rasterfall_model_self.o: $(RASTERFALL_SRC)/rasterfall_model.c \
                                  $(RASTERFALL_INC)/rasterfall_model.h $(SELF_CC) | $(BUILD)
	@printf "  $(BLUE)  CC(s)  %s\n" "$<"
	$(SELF_CC) $(SELF_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@

$(BUILD)/rasterfall_humanoid_basis_self.o: $(RASTERFALL_SRC)/rasterfall_humanoid_basis.c \
                                           $(RASTERFALL_INC)/rasterfall_humanoid_basis.h $(SELF_CC) | $(BUILD)
	@printf "  $(BLUE)  CC(s)  %s\n" "$<"
	$(SELF_CC) $(SELF_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@

$(BUILD)/rasterfall_humanoid_retarget_self.o: $(RASTERFALL_SRC)/rasterfall_humanoid_retarget.c \
                                              $(RASTERFALL_INC)/rasterfall_humanoid_retarget.h $(SELF_CC) | $(BUILD)
	@printf "  $(BLUE)  CC(s)  %s\n" "$<"
	$(SELF_CC) $(SELF_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@
...
$(BUILD)/rf_gpu_scene_%_self.o: rasterfall/src/rf_gpu_scene_%.c $(SELF_CC) | $(BUILD)
	$(SELF_CC) $(SELF_CFLAGS) -I $(RASTERFALL_INC) -c $< -o $@
