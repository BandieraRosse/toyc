...
| 工作 | 入口 |
| --- | --- |
| 实机复现、帧审计、参数 | `docs/rasterfall/architecture/runtime.md`、`docs/rasterfall/guides/gpu-validation.md`；`build-windows/rasterfall-windows/rasterfall.exe --help` |
...
| Windows package 与实机验证 | `docs/rasterfall/guides/build-platforms.md`、`windows/NativeCodex.ps1` |
