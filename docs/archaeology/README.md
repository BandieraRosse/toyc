...
> **Toyc Archaeology V1 — FROZEN**
> 冻结日期：2026-09-16。当前版本已经固定项目传承、核心 Git 事实和最重要的作者声音。
> 未来仅在自然发现重要原始战略 prompt、完整关键历史会话，或足以显著改变 author/agent
> attribution 的新材料时局部解冻；不再主动扩大资料搜索范围。

本文档集保存 Toyc 的项目谱系、技术演化和开发实践，避免未来只凭几个分散仓库重新调查，也保存
Git 记录不了、可能随时间遗忘的动机、工作方式和工程取舍。考古范围以 Tinylibc、ToyCCompiler 与
Toyc 为主体，同时追溯 Tinylibc 从 SC7 团队操作系统项目分离的必要前史。

这里追求的是方向正确、核心事实有依据、重要口述与证据边界得到保存，而不是建立穷尽所有原始材料、
可以脱离现有仓库完全复现实验现场的档案库。SC7、上游参考项目和赛事环境只考证到足以解释 Toyc
主线的位置；它们与 Toyc 没有持续关系的部分，不因可能存在更多材料而继续扩张。
...
Toyc Archaeology V1 已于 2026-09-16 冻结。本轮考古已经按上述范围收尾：Q00—Q10 均有稳定落点，SC7、Tinylibc、ToyCCompiler、Toyc 整合和
Rasterfall 转向已经形成连续叙事、时间线与提交级证据表。就保存 Toyc 自身传承、核心事实和重要
Git 外背景的目标而言，当前没有必须继续访谈或核查的问题；核心作者访谈原文另见
[口述史料](oral-history/README.md)。

尚未取得的赛事原始材料、课程与论文附件、musl 精确参考快照、完整关键 agent 开发会话，以及 `fca878f` 前
未提交种子和 stage 日志，只限制个别细节能够达到的证据强度。各时期文档已在相应位置明确这些
边界；除非未来自然出现与主线直接相关的新材料，不把它们保留为主动待办，也不为追求形式上的资料
齐全而扩大考古范围，更不因这些缺失推翻现有提交级结论。

冻结不表示材料永远不能修订。未来只有在自然发现重要原始战略 prompt、完整关键历史会话，或能
显著改变 author/agent attribution 的新材料时，才对直接受影响的局部文档解冻；普通旁证、重复
构建日志和可由 Git 重建的材料不构成解冻理由。
