...
3. **B2c — viewmodel：** 依次迁移 opaque weapon geometry、hands/pill/attachments 和
   ...
   muzzle 保持 world EFFECTS，outer/lobe 使用 Transparent V1 的真实 material alpha；death fade、
   透明 world/RFM2 与其他 producer 仍属于 B2d 后续迁移。
