...
| GPU-8B2 | IN PROGRESS / LOCAL PASS | retained consumer 和整帧 replay 已建立；frame audit 区分各层 command/direct-pixel debt 并记录 fallback reason；effects opaque producer 已完成 command 化并建立 direct-pixel 零门禁；Transparent V1 B2d-0..3 已通过 ABI/CPU/full-scan/tile-binned/logic 门禁，B2d-4a/4b 已将普通 RFM2 material alpha 与 RGBA texel alpha 接入真实 producer，muzzle outer/lobe 与 enemy dissolve death fade 已迁移，组合 alpha、其他透明 world producer 与 B2d-5 待完成 |
