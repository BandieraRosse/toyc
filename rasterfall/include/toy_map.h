...
enum toy_map_pickup_kind {
    ...
    ,TOY_MAP_PICKUP_ATTACK_X2_BUTTON
    ,TOY_MAP_PICKUP_ATTACK_X3_BUTTON
    ...
    ,TOY_MAP_PICKUP_WEST_CORRIDOR_NO_TANK_BUTTON
    ,TOY_MAP_PICKUP_ENEMY_DEATH_TEST_BUTTON
    ,TOY_MAP_PICKUP_STATION_TERMINAL
