...
#define TOY_CONFIG_CHARGER_KNOCKBACK_DISTANCE 2304 /* 目标水平距离：4.5m */
...
#define TOY_CONFIG_TANK_KNOCKBACK_DISTANCE    1536 /* 目标水平距离：3m */
#define TOY_CONFIG_TANK_KNOCKBACK \
    ((TOY_CONFIG_TANK_KNOCKBACK_DISTANCE + \
      TOY_CONFIG_AIRBORNE_FLIGHT_STEPS / 2) / \
     TOY_CONFIG_AIRBORNE_FLIGHT_STEPS)
