...
`--character-world-capture`；具体流程见 [`../docs/rasterfall/guides/character-art-acceptance.md`](../docs/rasterfall/guides/character-art-acceptance.md)
...
- [`../docs/rasterfall/architecture/animation-architecture.md`](../docs/rasterfall/architecture/animation-architecture.md)：模型与动画架构契约。
- [`../docs/rasterfall/network-architecture.md`](../docs/rasterfall/architecture/network-architecture.md)：联机架构与扩展边界。
