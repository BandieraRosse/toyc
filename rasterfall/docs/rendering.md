...
> 文档更新：2026-09-20
> 源码核对基线补充：2026-09-20 mixed 双 slot 仅复制离屏渲染状态，不复制窗口 presenter。swapchain/images 由 Vulkan backend 唯一拥有；slot 独立持有 acquire/render-complete semaphore。Intel 当前需在 present 后 queue-idle，`native_present_queue_idle_ms` 为真实正确性同步成本。
