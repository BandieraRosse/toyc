...
> 文档更新：2026-09-06
> 源码核对基线：工作区（本地玩家移动/跳跃/airborne/武器/动画/special-control 由 `actors[0]` 直接驱动；生成距离、安全室/战役目标、敌人近战/Tank 受击、爆炸目标和特感索敌已按 actor 规则处理；legacy 主要供兼容入口、旧测试和展示适配；AI 从槽位 1 起分配；投射物/燃烧区携带 actor owner）
