...
> 文档更新：2026-09-09
> 源码核对基线：工作区（Character Importer V1：RFCHAR GLB → RFM2 v14/SKN1/CHR1 → stable API/CPU skinning/固定 model capture；RF Humanoid Art Acceptance Character V1 generator/manifest 已加入；其余主线同现有工作区）
