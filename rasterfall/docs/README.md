...
> 文档更新：2026-09-17
> 源码核对基线：GPU-0 ～ GPU-8A 已完成；RenderFrame V1 已建立单调层 cursor，normal frame 按 sky/world/transparent/effects/viewmodel/overlay 契约提交；effects 与 viewmodel 分别 flush 后才切换到唯一 screen-overlay target。GPU-8B1、GPU-9A 仍待 Windows normal-frame 冻结，post-world GPU consumer 尚未迁移。
