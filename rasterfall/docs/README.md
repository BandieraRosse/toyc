...
> 文档更新：2026-09-10
> 源码核对基线：工作区（Lighting V1；RF Humanoid V2.1 Final Body 与 Profession Visual System V1 六职业 lineup；Headgear V1；CHR1 bind 基底与双手 socket IK；Eula authored walk clip lazy-load 与逐角色实景距离验收）
