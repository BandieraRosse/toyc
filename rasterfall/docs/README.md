...
> 文档更新：2026-09-10
> 源码核对基线：工作区（Enemy Presentation V1 90% raster dissolve / 10% legacy death；Humanoid Action Composition V1.1 additive recoil；modular RFANIM presentation clock；双手 RFANIM 持枪轨道；RFCHAR +Z forward basis；PRIMARY_GRIP weapon presentation；开发者 world strip 与战斗区共用 modular path；双正式四人小队 runtime）
